...
export const uploadFile = (req, res, next, cb) => {
  //TODO rewrite this
  var prefix = "";
  if (req.originalUrl) {
...
export const deletFiles = (req, res) => {
  if (req.body) {
    req.body.forEach((el) => {
...
export const findFile = (model, req, res) => {
  model
...
export const register = (model, req, res) => {
...
export const login = (model, req, res) => {
  const params = req.body;
  console.log(params);
...
export const deleteById = (model, req, res) => {
  model
    ...
    .catch((error) => {
      res.status(400).json({
        message: "No se pudo borrar el objeto",
        error,
      });
    });
};

export const find = (model, req, res) => {
...
export const save = (model, req, res) => {
  const params = req.body;
...
export const update = (model, req, res) => {
  const body = req.body;
...
export const deleteAll = (model, req, res) => {
  model
    .deleteMany()
    .then((data) => {
      return res.status(200).json(data);
...
export const parseQueryString = (req) => {
